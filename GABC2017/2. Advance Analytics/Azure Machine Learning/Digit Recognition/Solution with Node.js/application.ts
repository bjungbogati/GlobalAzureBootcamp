...
class PixelGrid {
    ...
    postRequest(request: any) {
        ...
        const url = 'https://ussouthcentral.services.azureml.net/workspaces/eb2f429071cb45f19274b50316b18bfb/services/4c55d9ddca784c3faaeda1eb43888f8c/execute?api-version=2.0&details=true';
        const apiKey = '05m6aINh2MTmJgXK/ngv+BPD40sQTQ4QLZbhlGVVhbo4aiummzRrhjJ1nJfSdNan+aMeVO7WwUV1a3S8w6ZmYg==';
